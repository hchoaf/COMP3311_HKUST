/* COMP3311 Lab 6 Exercise: Lab6DB.sql */

clear screen
set feedback off
set heading off
select '*** Creating Lab 6 database ***' from dual;
set heading on
...
create table Student (
    ...
    constraint CHK_studentId check (regexp_like(rtrim(studentId), '^[0-9]{8}$')),
    constraint CHK_email unique (email),
    constraint CHK_phoneNo check (regexp_like(rtrim(phoneNo), '^[0-9]{8}$')),
	constraint CHK_cga check (cga between 0.00 and 4.00),
    constraint CHK_admissionYear check (regexp_like(rtrim(admissionYear), '^2[0-9]{3}$')));
...
create table Course (
    ...
    constraint CHK_courseId check (regexp_like(rtrim(courseId), '^[A-Z]{4}[0-9]{4}$')));
...
insert into Student values ('13455789','Harry','Potter','cspotter','23581234',null,'COMP','2017');
insert into Student values ('15456789','Leonardo','Da Vinci','csdavinci','23585678',null,'COMP','2017');
insert into Student values ('13556789','Legolas','Greenleaf','magreenleaf','23582468',null,'MATH','2018');
insert into Student values ('13456789','Ariana','Grande','csgrande','23581234',null,'COMP','2018');
insert into Student values ('15678989','Maria','Callas','cscallas','23589876',null,'COMP','2018');
insert into Student values ('15678901','Albert','Einstein','cseinstein','23585678',null,'COMP','2017');
insert into Student values ('16789012','Robert','Redford','maredford','23582468',null,'MATH','2018');
insert into Student values ('14567890','Julius','Caesar','eecaesar','23589876',null,'ELEC','2018');
insert into Student values ('99987654','Lazzy','Lazy','cslazy','23581357',null,'COMP','2018');
insert into Student values ('26184624','Bruce','Wayne','eewayne','28261057',null,'ELEC','2017');
insert into Student values ('26184444','Donald','Trump','bstrump','28255057',null,'BUS','2018');
insert into Student values ('26186666','Warren','Buffet','bsbuffet','28266027',null,'BUS','2017');
insert into Student values ('66666666','Ferris','Bueller','bsbueller','28282727',null,'BUS','2017');
insert into Student values ('15000655','Steve','Jobs','csjobs','26232244',null,'COMP','2017');
insert into Student values ('15085942','Bill','Gates','csgates','25678679',null,'COMP','2018');
insert into Student values ('28834512','Isaac','Newton','manewton','22861987',null,'MATH','2017');
insert into Student values ('28918856','Alan','Turing','maturing','26679834',null,'MATH','2017');
insert into Student values ('29873381','Nikola','Tesla','eetesla','25671983',null,'ELEC','2017');
insert into Student values ('13782973','Edith','Clarke','eeclarke','28340180',null,'ELEC','2017');
insert into Student values ('18792018','Elon','Musk','bsmusk','28659910',null,'BUS','2018');
