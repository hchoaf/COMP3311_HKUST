<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditFYP.aspx.cs" Inherits="FYPMSWebsite.Faculty.EditFYP" %>
    ...
    <div class="form-horizontal">
        ...
        <asp:Panel ID="pnlFYPInfo" runat="server">
            ...
            <div class="form-group" role="row">
                <!-- Title input control -->
                <asp:Label runat="server" Text="Title:" CssClass="control-label col-xs-2" AssociatedControlID="txtTitle" Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-xs-10">
                    ...
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="The title field is required." ControlToValidate="txtTitle"
                        CssClass="text-danger" Display="Dynamic" EnableClientScript="False" ValidationGroup="FYPValidation" Font-Names="Arial" Font-Size="Small"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="form-group" role="row">
                <!-- Description input control -->
                <asp:Label runat="server" Text="Description:" CssClass="control-label col-xs-2" AssociatedControlID="txtDescription" Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-xs-10">
            ...
            <div class="form-group" role="row">
                ...
                <asp:Label runat="server" Text="Co-supervisor:" CssClass="control-label col-xs-2" AssociatedControlID="ddlCosupervisor" Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-xs-2">
                    <asp:DropDownList ID="ddlCosupervisor" runat="server" Font-Names="Arial" Font-Size="Small">
                    </asp:DropDownList>
                </div>
                <!-- Category input control -->
                <asp:Label runat="server" Text="Category:" CssClass="control-label col-xs-1" AssociatedControlID="ddlCategory" Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-xs-3">
                ...
                <asp:Label runat="server" Text="Type:" CssClass="control-label col-xs-1" AssociatedControlID="rblType" Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-xs-3">
            ...
            <div class="form-group" role="row">
                ...
                <asp:Label runat="server" Text="Requirements:" CssClass="control-label col-xs-2" AssociatedControlID="txtRequirements" Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-xs-10">
                    <asp:TextBox ID="txtRequirements" runat="server" CssClass="form-control input-sm" MaxLength="200" Wrap="False" Font-Names="Arial" Font-Size="Small"></asp:TextBox>
                </div>
            </div>
            <div class="form-group" role="row">
                <!-- Minimum number of students input control -->
                <asp:Label runat="server" Text="Minimum number of students in this FYP (1 if individual):" CssClass="control-label col-xs-7"
            ...
            <div class="form-group" role="row">
                ...
                <asp:Label runat="server" Text="Maximum number of students in this FYP (1 if individual):" CssClass="control-label col-xs-7"
            ...
            <div class="form-group" role="row">
                <div class="col-xs-offset-2">
                    <asp:CompareValidator runat="server" ErrorMessage="The minimum number of students cannot be greater than the maximum number of students."
                        ControlToCompare="rblMinStudents" ControlToValidate="rblMaxStudents" ValidationGroup="FYPValidation"
            ...
            <div class="form-group" role="row">
                <!-- Close FYP input control -->
                <asp:Label runat="server" Text="Close this FYP:" CssClass="control-label col-xs-2" AssociatedControlID="rblIsAvailable"
            ...
            <div class="form-group" role="row">
                <div class="col-xs-offset-2 col-xs-2">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update FYP" CssClass="btn-sm" ValidationGroup="FYPValidation"
